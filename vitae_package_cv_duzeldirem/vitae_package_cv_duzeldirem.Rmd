...
-   Data Visualizations
-   Communication: Quarto, R Markdown, R Shiny, Teaching
-   Sample R Shiny web app: [Link to the app](https://turalsadigov.shinyapps.io/my_new_ames_app/)
...
tribble(
  ...
  "Bronze Medal", "2003", "IMO",
  "Gold Medal (four times)", "2000-03", "Azerbaijan Mathematical Olympiads"
) %>% 
