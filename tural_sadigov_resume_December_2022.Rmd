...
-   **Visualization and communication**
    ...
    -   Communication, reporting, visualization and dashboard: Quarto, R Markdown, Jupyter Notebook, R Shiny. Sample R Shiny web app: [Link to the app](https://turalsadigov.shinyapps.io/my_new_ames_app/).

-   **Leadership and collaboration**

    -   Actively advising and mentoring students in data science and mathematocs majors at Hamilton College, and supervised all adjunct lecturers at SUNY Polytechnic Institute as Math Service Coordinator (position similar to an associate chair)
...
-   Applied Mathematics Lecturer and Math Service Coordinator, "2015 - 20, SUNY Polytechnic Institute
    ...
    -   BDelivered technical lectures in undergraduate and graduate levels
